...
{
    /// <summary>
    /// Base for components that listen to Fungus.GameEvent sub types, routes param through a 
    /// UnityEvent configured in the inspector of the same parameter type.
    ///
    /// Primarily exists to allow for inspector compatible sub types to be simply a matter of 
    /// declaring types in their own file. See IntGameEventListener for an example.
    /// </summary>
